    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cover_photo', models.ImageField(blank=True, null=True, upload_to='profile_covers/', verbose_name='cover photo')),
                ('avatar_3d', models.ImageField(blank=True, null=True, upload_to='avatars/3d/', verbose_name='3D avatar')),
        ...
        migrations.CreateModel(
            ...
            options={
                'ordering': ['-created_at'],
                'constraints': [models.UniqueConstraint(fields=('user', 'following_user'), name='unique_followers'), models.CheckConstraint(condition=models.Q(('user', models.F('following_user')), _negated=True), name='no_self_follow')],
            },
        ),
    ]
